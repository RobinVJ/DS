...
public class TestChainHashTableUsingMultiplicationHashing {

   @Test
   public void create() {
      ChainHashTable<Integer, String> dat = HashTableBuilder.getMultiplicationBasedHashTable(4);
   ...
   @Test
   public void lookUp() {
      ChainHashTable<String, Integer> dat = HashTableBuilder.getMultiplicationBasedHashTable(4);
      dat.insert("1", 1);
      dat.insert("2", 2);
      dat.insert("3", 1);
   ...
   public void insertDeleteLookUp() {
      ...
      dat = HashTableBuilder.getMultiplicationBasedHashTable(1);
      dat.insert(1, "1");
      dat.insert(2, "2");
      dat.insert(3, "3");
      dat.insert(4, "4");
